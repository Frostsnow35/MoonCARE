    ...
    def build_screening_report(
        ...
        if level == "mild_or_none":
            return (
                ...
                "这些变化目前还属于可以观察和慢慢照顾自己的范围；这份小结仅供自我观察参考，不等于正式诊断。\n\n"
                "你接下来可以先试试：\n"
        ...
        if level == "moderate_to_severe_pms":
            return (
                ...
                "这不代表你有问题，也不等于正式诊断；它只是说明你的身体和情绪在这个阶段更需要被好好照顾。\n\n"
                "你接下来可以优先试试：\n"
        ...
        return (
            ...
            "这份内容只是基于本次聊天整理出的参考小结，不等于正式诊断，但说明你现在很需要被更认真地照顾。\n\n"
            "你接下来最重要的是：\n"
            "1. 先把这段状态告诉一个可信任的人，不要一个人扛着\n"
            "2. 尽快考虑咨询妇科或心理健康专业人员，做更完整的评估\n"
            "3. 在产品内先使用呼吸、音乐或情绪日记这类低负担工具，慢慢把身体和情绪稳定下来"
        )
